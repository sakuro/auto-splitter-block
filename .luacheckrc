...
-- The busted std covers the DSL, not Factorio's globals. spec/support/factorio.lua
-- installs those with `_G.storage = ...`, and the specs then read and write
-- `storage` bare, which luacheck cannot follow back to that assignment.
files["spec/**/*_spec.lua"] = { globals = { "storage" } }
